...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void MyInput()
    {
        ...
        else if (Input.GetKey(jumpKey) && secondJump && readyToJump)
        {
            readyToJump = false;
            secondJump = false;
    ...
    private void Dash()
    {
        ...
        if (locked == false) 
            forceToApply = orientation.forward * dashForce + orientation.up * dashUpForce;
        else
            forceToApply = (currentLockOn.position - transform.position).normalized * dashForce + (currentLockOn.position - transform.position).normalized * dashUpForce;
